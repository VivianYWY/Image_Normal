//this code can only process image with 8-bit, for other images like 16 bit, need to revise further
...
public class ImageUtils {
    ...
    public static void main(String[] args) {
       ...
       // ImageUtils.cut2("e:/abc.jpg", "e:/", 2, 2 );//测试OK
        // 方法三：指定切片的宽度和高度
    	//目前，这种方法只能切割8bit的图像，16bit的不行，会报错，估计问题在bufferedimage bi 那里
        ImageUtils.cut3("E:/Cloud65535.png", "E:/", 256, 256 );//测试OK33333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333
    ...
    public final static void cut3(String srcImageFile, String descDir,
        ...
        try {
            ...
            //对于16bit的图像，会报错，因为下面这行代码有问题，bi为 null
                    ...
                    for (int j = 0; j < cols; j++) {
                        ...
                        img = Toolkit.getDefaultToolkit().createImage(
                                new FilteredImageSource(image.getSource(),
                                        cropFilter));
                        BufferedImage tag = new BufferedImage(destWidth,
                                destHeight, BufferedImage.TYPE_USHORT_GRAY);
                        Graphics g = tag.getGraphics();
                        g.drawImage(img, 0, 0, null); // 绘制缩小后的图
                        g.dispose();
                        // 输出为文件
